...
public class GestionOnlineComunicarSiniestrosPage
{
	final static Logger logger = LoggerFactory.getLogger(GestionOnlineComunicarSiniestrosPage.class);
	...
	public GestionOnlineComunicarSiniestrosPage(BrowserContext browserContext)
	{
			...
			String numPoliza)
	{
		...
		this.wh.sendValueToWebElementInFrame(this.txtPoliza, this.contenidoFrame, numPoliza);
			...
			String fechaSiniestro)
	{
		...
		this.wh.sendValueToWebElementInFrame(this.txtFechaSiniestro, this.contenidoFrame, fechaSiniestro);
			...
			String causa)
	{
		...
		this.wh.sendValueToWebElementInFrame(this.drpdwnCausa, this.contenidoFrame, causa);
			...
			String descripcion)
	{
		...
		this.wh.sendValueToWebElementInFrame(this.txtDescripcionSiniestro, this.contenidoFrame, descripcion);
			...
			String rolPersonaContacto)
	{
		...
		this.wh.sendValueToWebElementInFrame(this.drpdwnRol, this.contenidoFrame, rolPersonaContacto);
			...
			String nombrePersonaContacto)
	{
		...
		this.wh.sendValueToWebElementInFrame(this.txtContactoNombre, this.contenidoFrame, nombrePersonaContacto);
			...
			String apellido1PersonaContacto)
	{
		...
		this.wh.sendValueToWebElementInFrame(this.txtContactoApellido1, this.contenidoFrame, apellido1PersonaContacto);
			...
			String tlf1PersonaContacto)
	{
		...
		this.wh.sendValueToWebElementInFrame(this.txtContactoTelefono1, this.contenidoFrame, tlf1PersonaContacto);
