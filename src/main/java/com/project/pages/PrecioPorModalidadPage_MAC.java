...
public class PrecioPorModalidadPage_MAC {
	...
	public void completarRentaMensualAlquiler(String scenario) {
		...
		this.webDriver.clearAndAppendTextInFrame(this.txtRenta, this.cuerpoFrame, String.valueOf(tCData.getScenarioVar(scenario, "renta_mensual_alquiler")));
	...
	public void seleccionarImpagoAlquiler(String scenario) {
		...
		this.webDriver.clickElementFromDropDownByTextInFrame(this.drpdnImpagoAlquiler, this.cuerpoFrame, String.valueOf(this.tCData.getScenarioVar(scenario, "impago_alquiler")));
	...
	public void seleccionarFranquicia(String scenario) {
		...
		this.webDriver.clickElementFromDropDownByTextInFrame(this.drpdnFranquicia, this.cuerpoFrame, String.valueOf(tCData.getScenarioVar(scenario, "franquiciaMAC")));
