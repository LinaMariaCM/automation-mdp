...
public class MediadoresAltaProspectPage {
	...
	// LoggerFactory.getLogger(MediadoresAltaProspectPage.class);
	...
	//
	// // region methods
	// public void executeActionsAltaProspectPage() throws InterruptedException,
	// IOException
	// {
	...
	// }
	//
	// public void completarDatosDireccion() throws InterruptedException,
	// IOException
	// {
	...
	// // this.wh.sendValueToWebElementInFrame(this.drpdwnNivelEstructura,
	// this.mainFrame,
	...
	// // this.wh.sendValueToWebElementInFrame(this.drpdwnTipoProspect,
	// this.mainFrame,
	// // String.valueOf(this.tData.getTipoProspect()));
	// this.wh.sendValueToWebElementInFrame(this.drpdwnTipoProspect,
	// this.mainFrame, String.valueOf(this.tData.getTipoProspect()));
	...
	// // this.wh.sendValueToWebElementInFrame(this.drpdwnActividadPrincipal,
	// this.mainFrame,
	...
	// this.wh.sendValueToWebElementInFrame(this.txtNombreComercialProspect,
	// this.mainFrame, String.valueOf(this.tData.getNombreComercialProspect()));
	...
	// this.wh.sendValueToWebElementInFrame(this.drpdwnIdioma, this.mainFrame,
	...
	// this.wh.sendValueToWebElementInFrame(this.drpdwnEjecutivoComercial,
	...
	// this.wh.clickOnWebElementInFrame(this.btnAsignarDomicilio,
	// this.mainFrame);
	...
	// String.valueOf(this.tData.getProvincia()));
	// this.wh.sendValueToWebElement(this.txtProvincia,
	// String.valueOf(this.tData.getProvincia()));
	...
	// String.valueOf(this.tData.getPoblacion()));
	// this.wh.sendValueToWebElement(this.txtPoblacion,
	// String.valueOf(this.tData.getPoblacion()));
	...
	// this.wh.switchToFrame(this.mainFrame);
	// this.wh.switchToFrame(this.modalFrame);
	// this.wh.sendValueToWebElement(this.txtVia,
	// String.valueOf(this.tData.getNombreVia()));
