...
{
/*	final static Logger logger = LoggerFactory.getLogger(UbicacionRiesgoPage.class);
...
*/
	...
	//@FindBy(xpath = ".//*[text()='Añadir inmueble' and @ng-click='ur.addInmueble()' and @ng-disabled='ur.disableAddInmuebleButton']")
	...
	private By radioBtnCriterioBusquedaReferenciaCatastral;
	
	@FindBy(name = "refCatastral")
	private By txtReferenciaCatastral;
	...
	private By txtProvincia;
	
	@FindBy(name = "poblacion")
	private By txtPoblacion;
	
	@FindBy(name = "nombreVia")
	private By txtNombreVia;
	
	@FindBy(name = "numVia")
	private By txtNumeroVia;
	
	@FindBy(name = "codigoPostal")
	private By txtCodigoPostal;
	
	//@FindBy(xpath = ".//*[@tabindex='-1' and contains(@ng-bind-html,'match.label')]")
	private By lblMatchFoundElement = By.xpath(".//*[@tabindex='-1' and contains(@ng-bind-html,'match.label')]");
	
	//@FindBy(xpath = ".//*[contains(@ng-bind-html,'match.model.street') and contains(@ng-bind-html,'|')]")
	private By lblMatchFoundElementVia = By.xpath(".//*[contains(@ng-bind-html,'match.model.street') and contains(@ng-bind-html,'|')]");
	
	//@FindBy(xpath = ".//*[text()='Al acceder en modo modificación las retenciones que su perfil lo permitan quedarán aceptadas de manera automática en cada paso.']")
	...
	//@FindBy(xpath = ".//*[text()='Modificar inmueble' and @ng-click='ur.modalBuscador.updateInmueble()']")
	private By btnModificarInmueble = By.xpath(".//*[text()='Modificar inmueble' and @ng-click='ur.modalBuscador.updateInmueble()']");
	
	//@FindBy(xpath = ".//*[contains(@ng-bind-html,'inmuebleSeleccionado.data.refCatastral')]")
	...
	private By cbkCalidadConstruccion;
	
	//@FindBy(xpath = ".//*[@ng-click='ur.editInmueble()']")
	private By btnLapiz = By.xpath(".//*[@ng-click='ur.editInmueble()']");
	
	//@FindBy(xpath = ".//*[@id='inmuebleModal']/div/div/div[2]/div/div[2]/div/div/table/tbody/tr[1]/td[3]")
	...
	*/
	...
	public boolean fillInmuebleAndGetAvailability() 
		...
		//return this.addInmueble(this.browserContext.getTestCaseData().getInmueble());
		return this.addInmueble(tCData.getTestVar(testId, "inmueble"));
	}

	
	public void fillInmuebleAndClickOnContinue()
					throws InterruptedException	{
		//this.addInmueble(this.browserContext.getTestCaseData().getInmueble());
		this.fillInmuebleAndGetAvailability();
	...
	public boolean addInmueble(String inmueble) 
		...
		else {//value = this.addInmuebleByReferenciaCatastral(this.browserContext.getTestCaseData().getReferenciaCatastral());
			value = this.addInmuebleByReferenciaCatastral(tCData.getTestVar(testId, "referencia_catastral"));
		}
		/*
		 * switch (inmueble) { case MutuaPropietariosConstants.ReferenciaCatastralPorDefecto: System.out.println("Primer case"); value =
		 * this.addInmuebleByReferenciaCatastral(this.browserContext.getTestCaseData().getReferenciaCatastral()); break; case
		 * MutuaPropietariosConstants.DireccionPorDefecto: System.out.println("Segundo case"); value = this.addInmuebleByAddress(); break; }
		 */
	...
	public boolean addInmuebleByAddress()
		...
		//this.webDriver.moveToElementInFrameWithJavaScript(this.btnAnadirInmueblePantallaPrincipal, this.cuerpoFrame);
		...
		this.webDriver.appendTextInFrame(this.txtProvincia, this.cuerpoFrame,
				String.valueOf(this.browserContext.getTestCaseData().getDireccionProvincia()));
		*/
		this.webDriver.appendTextInFrame(this.txtProvincia, this.cuerpoFrame,
			String.valueOf(this.tCData.getTestVar(testId, "direccion_provinvia")));
		...
		this.webDriver.appendTextInFrame(this.txtPoblacion, this.cuerpoFrame,
				String.valueOf(this.browserContext.getTestCaseData().getDireccionPoblacion()));
		*/
		this.webDriver.appendTextInFrame(this.txtPoblacion, this.cuerpoFrame,
			String.valueOf(this.tCData.getTestVar(testId, "direccion_poblacion")));
		
		this.webDriver.clickInFrame(this.lblMatchFoundElement, this.cuerpoFrame);
		
		/*
		this.webDriver.appendTextInFrame(this.txtNombreVia, this.cuerpoFrame,
				String.valueOf(this.browserContext.getTestCaseData().getDireccionNombreVia()));
		*/
		this.webDriver.appendTextInFrame(this.txtNombreVia, this.cuerpoFrame,
			String.valueOf(this.tCData.getTestVar(testId,"direccion_nombre_via")));
		...
		this.webDriver.appendTextInFrame(this.txtNumeroVia, this.cuerpoFrame,
				String.valueOf(this.browserContext.getTestCaseData().getDireccionNumeroVia()));
		*/
		this.webDriver.appendTextInFrame(this.txtNumeroVia, this.cuerpoFrame,
			String.valueOf(this.tCData.getTestVar(testId, "direccion_numero_via")));
		
		/*
		this.webDriver.appendTextInFrame(this.txtCodigoPostal, this.cuerpoFrame,
				String.valueOf(this.browserContext.getTestCaseData().getDireccionCodigoPostal()));
		*/
		this.webDriver.appendTextInFrame(this.txtCodigoPostal, this.cuerpoFrame,
			String.valueOf(this.tCData.getTestVar(testId, "direccion_codigo_postal")));
		...
		//boolean value = this.webDriver.isPresentInFrameAndClick(this.btnAnadirInmuebleReferenciaCatastral, this.cuerpoFrame);
		boolean value = this.webDriver.isPresentAndClickInFrame(this.btnAnadirInmuebleReferenciaCatastral, this.cuerpoFrame);
		// this.webDriver.clickInFrame(this.btnAnadirInmuebleReferenciaCatastral, this.cuerpoFrame);
	...
	public boolean addInmuebleByReferenciaCatastral(
			String referenciaCatastral)
	{
		logger.debug("BEGIN - AddInmuebleByReferenciaCatastral");
		//this.webDriver.waitForPageLoadWithAngular();
		//this.webDriver.waitForAngular();
		// this.webDriver.moveToElementInFrameAndClickWithJavaScript(this.btnAnadirInmueblePantallaPrincipal, this.cuerpoFrame);
		this.webDriver.clickInFrame(this.btnAnadirInmueblePantallaPrincipal, this.cuerpoFrame);
		//this.webDriver.waitForPageLoadWithAngular();
		//this.webDriver.waitForAngular();
		this.webDriver.clickInFrame(this.radioBtnCriterioBusquedaReferenciaCatastral, this.cuerpoFrame);
		this.webDriver.appendTextInFrame(this.txtReferenciaCatastral, this.cuerpoFrame, referenciaCatastral);
		this.webDriver.clickInFrame(this.btnBuscar, this.cuerpoFrame);
		//this.webDriver.waitForAngular();
		
		this.asegurarUnicamenteGarajes();
		
		//this.browserContext.webElementHelper.clickInFrame(this.btnAnadirInmuebleReferenciaCatastral, this.cuerpoFrame);
		this.webDriver.clickInFrame(this.btnAnadirInmuebleReferenciaCatastral, this.cuerpoFrame);
	...
	public void clickOnContinuar()
	{
		...
		//this.webDriver.waitForAngular();
		this.webDriver.switchToFrame( this.cuerpoFrame);
		//this.GuardarRefCatastral(this.webDriver.getTextInFrame(this.txtCurrentReferenciaCatastral, this.cuerpoFrame));
	...
	public void modifyReferenciaCatastral()
	{
		...
		//String expectedReferenciaCatastral = this.browserContext.getTestCaseData().getReferenciaCatastral();
	...
	public void editInmuebleAndExcluirGarajesYLocales()
	{
		...
		if(Boolean.parseBoolean(this.tCData.getTestVar(testId, "ExcluirGarajes")) || Boolean.parseBoolean(this.tCData.getTestVar(testId, "ExcluirLocales")))
		{
			...
			//if (!this.chkExcluirGarajes.isSelected() && this.tCData.isExcluirGarajes())
			...
			//if (!this.chkExcluirLocales.isSelected() && this.tCData.isExcluirLocales())
	...
	public void editCalidadConstruccion()
	{
		...
		{
			this.webDriver.switchToFrame(this.cuerpoFrame);
			//this.webDriver.selectValueInDropDown(this.cbkCalidadConstruccion, this.tCData.getCalidadConstruccion());
			...
			for (int i = 0; i < tablaHash.size(); i++)
			{
				...
				if (dropDownPresent)
				{
					...
					//	this.webDriver.waitForPageLoadWithAngular();
						...
						//this.webDriver.waitForWebElementInFrame(this.resultadoBusqueda, this.cuerpoFrame);
			...
			String nombreFichero) throws Exception
	{
		...
		//this.webDriver.waitForPageLoadWithAngular();
		//this.webDriver.moveToElementAndClickInFrame(this.btnAnadirInmueblePantallaPrincipal, this.cuerpoFrame);
		...
		for (int i = 0; i < tablaHash.size(); i++)
		{
			...
			catch (Exception e)
			{
				...
				/*this.browserContext.initializeVariables(this.browserContext.getTestCaseData().getAcceso());
				
				this.wh = this.browserContext.webElementHelper;
				PageFactory.initElements(this.browserContext.getWebDriver(), this);
				this.browserContext.applicationAccessHelper.login(this.browserContext.getTestCaseData().getUsuario(),
