...
public class MediadoresHomePage
{
//	final static Logger logger = LoggerFactory.getLogger(MediadoresHomePage.class);
...
//		this.wh.doubleClickOnWebElementInFrame(this.btnAltaProspect, this.menuFrame);
...
//		this.wh.doubleClickOnWebElementInFrame(this.btnAltaMediador, this.menuFrame);
...
//		this.wh.doubleClickOnWebElementInFrame(this.btnRecepcion, this.menuFrame);
