...
public class InmueblePage_MAC {
	...
	//
	// this.wh.clickOnWebElementInFrame(this.btnAnadirInmueblePantallaPrincipal,
	// this.cuerpoFrame);
	// this.wh.sendValueToWebElementInFrame(this.txtProvincia, this.cuerpoFrame,
	// String.valueOf(this.tData.getInmuebleProvincia()));
	...
	// String.valueOf(this.tData.getInmueblePoblacion()));
	// this.wh.clickOnWebElementInFrame(this.itemPoblacion, this.cuerpoFrame);
	//
	// this.wh.sendValueToWebElementInFrame(this.txtNombreVia, this.cuerpoFrame,
	// String.valueOf(this.tData.getInmuebleNombreVia()));
	// this.wh.clickOnWebElementInFrame(this.itemNomVia, this.cuerpoFrame);
	//
	// this.wh.sendValueToWebElementInFrame(this.txtNumeroVia, this.cuerpoFrame,
	// String.valueOf(this.tData.getInmuebleNumeroVia()));
	//
