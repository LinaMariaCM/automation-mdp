...
{
	/*
	final static Logger logger = LoggerFactory.getLogger(InnovaHomePage.class);
	...
	*/
	...
	//@FindBy (id = "mainFrame")
	//@FindBy (css = "body > div:nth-child(2) > div.centro > div.cuerpo > #mainFrame")
	...
	*/
	...
	public void OpenGestionCotizaciones()
	{
		...
		// this.webDriver.moveToElementInFrameWithJavaScript(this.btnMapaSitio, this.menuFrame);
	...
	public void OpenGestionPolizas()
	{
		...
		// this.webDriver.clickInFrame(this.btnGestionPolizasMenu, this.menuFrame);
	...
	public void openInnovaHome()
	{
		...
		// this.webDriver.doubleClickInFrame(this.btnMenuPrincipal, this.menuFrame);
		// this.webDriver.moveToElementInFrameWithJavaScript(this.btnMenuPrincipal, this.menuFrame);
