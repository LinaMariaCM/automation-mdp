...
{
//	final static Logger logger = LoggerFactory.getLogger(DocumentacionPage_MAC.class);
...
//	}
//	
//	public void ExecuteActionsInDocumentacionPage() throws InterruptedException, IOException
//	{
//		logger.debug("BEGIN - ExecuteActionsInDocumentacionPage");
//		
//		// Click btn add documentacion
//		this.wh.clickOnWebElementInFrame(this.btnAnadirDocumentacionPantallaPrincipal, this.cuerpoFrame);
//		
//		// Click chkboxes
//		this.wh.clickOnWebElementInFrameWithJavaScript(this.chbxContrato, this.cuerpoFrame);
//		
//		// Click chkboxes
//		this.wh.clickOnWebElementInFrameWithJavaScript(this.chbxAceptacion, this.cuerpoFrame);
//		
//		// Click chkboxes
//		this.wh.clickOnWebElementInFrameWithJavaScript(this.chbxTitularidad, this.cuerpoFrame);
//		
...
//		
//		// Click chkboxes
//		this.wh.clickOnWebElementInFrame(this.chbxContratoContratacion, this.cuerpoFrame);
//
//		if (this.tData.getAcceso().equals(ProjectConstants.LoginAccessInnova))
//		{
//			this.wh.clickOnWebElementInFrame(this.chbxAceptacionMediador, this.cuerpoFrame);
//		}
//
//		this.wh.clickOnWebElementInFrame(this.chbxTitularidadContratacion, this.cuerpoFrame);
//		
//		this.wh.switchToFrame(this.cuerpoFrame);
//		this.txtFile.sendKeys("C:/Users/amaris2/Desktop/prueba.pdf");
//		this.wh.exitFromFrame();
//		this.wh.clickOnWebElementInFrame(this.btnAnadirContratacion, this.cuerpoFrame);
