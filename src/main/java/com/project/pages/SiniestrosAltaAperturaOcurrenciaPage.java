...
{
	final static Logger logger = LoggerFactory.getLogger(SiniestrosAltaAperturaOcurrenciaPage.class);
	...
	public SiniestrosAltaAperturaOcurrenciaPage(BrowserContext browserContext)
	{
	...
	public void clickRechazarApertura()
	{
		...
		this.wh.clickOnWebElementInFrame(this.btnRechazarApertura, this.mainFrame);
	...
	public void clickVolverABuscador()
	{
		...
		this.wh.clickOnWebElementInFrame(this.btnVolverABuscador, this.mainFrame);
			...
			String lugar)
	{
		...
		this.wh.sendValueToWebElementInFrame(this.drpdwnLugarOcurrencia, this.mainFrame, lugar);
			...
			String causa)
	{
		...
		this.wh.sendValueToWebElementInFrame(this.drpdwnGrupoCausas, this.mainFrame, causa);
			...
			String tipoCausa)
	{
		...
		this.wh.sendValueToWebElementInFrame(this.drpdwnTipoCausas, this.mainFrame, tipoCausa);
			...
			String descripcion)
	{
		...
		this.wh.sendValueToWebElementInFrame(this.txtDescripcionSiniestro, this.mainFrame, descripcion);
