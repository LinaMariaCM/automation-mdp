...
public class SiniestrosAltaAperturaPage
{
	final static Logger logger = LoggerFactory.getLogger(SiniestrosAltaAperturaPage.class);
	...
	@FindBy(id = "filtro1")
	private WebElement rdbtnNumPoliza;
	
	@FindBy(id = "filtro2")
	private WebElement rdbtnNombreTomador;
	
	@FindBy(id = "filtro3")
	private WebElement rdbtnNIF;

	@FindBy(id = "filtro4")
	private WebElement rdbtnOtros;
	
	@FindBy(xpath = ".//*[@id='capaAjax']/table[4]/tbody/tr[2]/td[12]/a/span")
	...
	public void selectBuscarPorNumPoliza()
	{
		...
		this.wh.doubleClickOnWebElementInFrame(this.rdbtnNumPoliza, this.mainFrame);
	...
	public void selectBuscarPorNombreTomador()
	{
		...
		this.wh.doubleClickOnWebElementInFrame(this.rdbtnNombreTomador, this.mainFrame);
	...
	public void clickContinuar()
	{
		...
		this.wh.doubleClickOnWebElementInFrame(this.btnContinuar, this.mainFrame);
