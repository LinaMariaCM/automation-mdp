...
//	}
	...
	public void CheckAvisoConstructionYearWithException()
	{
		...
		if (!this.tCData.getTestVar(testId, "construccion_edificio").equals("-1"))
		{
			if (this.lblAvisoModificacionAnyoConstruccion.size() == 1)
			{
				Assert.assertTrue(ProjectConstants.AvisoModificacionAnyoConstruccionNotPressent,
						this.lblAvisoModificacionAnyoConstruccion.get(0).isDisplayed());
			}
		}
	...
	// }
	// }
	// logger.debug("END - CheckAvisoAnyoRehabilitacionConduccionesComunitarias");
	// return false;
	// }
}
