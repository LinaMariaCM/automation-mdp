...
//	
//	@FindBy(css = "ul.ui-autocomplete.ui-menu.ui-widget.ui-widget-content.ui-corner-all")
...
//		this.wh.moveToElementInFrameWithJavaScript(this.fichaEdificioLink, this.menuFrame);
//		this.wh.doubleClickOnWebElementInFrame(this.fichaEdificioLink, this.menuFrame);
...
//		HashMap<String, HashMap<String, String>> tablaHash = loadDataFileToHashMap(nombreFichero, false);
//		
...
//			this.wh.sendValueToWebElementInFrame(this.txtRefCatastral, this.cuerpoFrame, getValuesDataSetByIndex(tablaHash, "ref_catastral", i));
//			
//			// Search
...
//			
//			if (this.wh.getTextFromWebElementInFrame(this.refCatResultado, this.cuerpoFrame)
//					.equals(this.wh.getTextFromWebElementInFrame(this.txtRefCatastral, this.cuerpoFrame)))
//			{
...
//		{
//			tablaHash = loadDataFileSectionToHashMapByInitialLineAndSize(nombreFichero, j, sectionSize, false);
//			// Iterate by number of lines
//			for (int i = 0; i < tablaHash.size(); i++)
//			{
//				boolean dropDownPresent = true;
//				String address = getValuesDataSetByIndex(tablaHash, "provincia", i) + " " + getValuesDataSetByIndex(tablaHash, "poblacion", i) + " "
//						+ getValuesDataSetByIndex(tablaHash, "direccion", i) + " " + getValuesDataSetByIndex(tablaHash, "numero", i);
//				// Print iteration process percentage
...
//				if (!this.wh.getTextFromWebElementInFrame(this.txtProvincia, this.cuerpoFrame).contains(getValuesDataSetByIndex(tablaHash, "provincia", i)))
//				{
//					// Fill provincia
//					this.wh.sendValueToWebElementInFrame(this.txtProvincia, this.cuerpoFrame, getValuesDataSetByIndex(tablaHash, "provincia", i));
//					dropDownPresent = this.wh.webElementInFrameIsPresentAndClick(this.menuItem1, this.cuerpoFrame);
//					if (!dropDownPresent)
...
//				if (dropDownPresent && !this.wh.getTextFromWebElementInFrame(this.txtPoblacion, this.cuerpoFrame)
//						.contains(getValuesDataSetByIndex(tablaHash, "poblacion", i)))
//				{
//					// Fill poblacion
//					this.wh.sendValueToWebElementInFrame(this.txtPoblacion, this.cuerpoFrame, getValuesDataSetByIndex(tablaHash, "poblacion", i));
//					dropDownPresent = this.wh.webElementInFrameIsPresentAndClick(this.menuItem2, this.cuerpoFrame);
//					if (!dropDownPresent)
...
//				if (dropDownPresent
//						&& !this.wh.getTextFromWebElementInFrame(this.txtVia, this.cuerpoFrame).contains(getValuesDataSetByIndex(tablaHash, "direccion", i)))
//				{
//					// Fill direccion
//					this.wh.sendValueToWebElementInFrame(this.txtVia, this.cuerpoFrame, getValuesDataSetByIndex(tablaHash, "direccion", i));
//					dropDownPresent = this.wh.webElementInFrameIsPresentAndClick(this.menuItem3, this.cuerpoFrame);
//					if (!dropDownPresent)
...
//					this.wh.sendValueToWebElementInFrame(this.txtNumVia, this.cuerpoFrame, getValuesDataSetByIndex(tablaHash, "numero", i));
//				// Fill codigo postal
//				if (this.wh.webElementInFrameIsPresent(this.txtPostCod, this.cuerpoFrame))
//				{
//					String codigoPostal = getValuesDataSetByIndex(tablaHash, "codigo_postal", i);
//					this.wh.sendValueToWebElementInFrame(this.txtPostCod, this.cuerpoFrame, codigoPostal.length() == 5 ? codigoPostal : "0" + codigoPostal);
//				}
//
//				if (dropDownPresent)
//				{
...
//						
//						// Wait result
//						System.out.println(this.wh.webElementInFrameIsPresent(this.resultadoBusqueda, this.cuerpoFrame) ? "Dirección normalizada"
//								: "Direccion no encontrada\n" + address);
//						this.wh.waitForWebElementInFrame(this.resultadoBusqueda, this.cuerpoFrame);
//						
//					}
...
//		this.wh.clickOnWebElementInFrame(this.rdbRefCatastral, this.cuerpoFrame);
//		// Set Ref Catastral
//		this.wh.clearAndSetTextInWebElementInFrame(this.txtRefCatastral, this.cuerpoFrame, this.tData.getReferenciaCatastral());
//	}
//	
...
//		this.wh.clickOnWebElementInFrame(this.rdbProyecto, this.cuerpoFrame);
//		// Set Proyecto
//		this.wh.clearAndSetTextInWebElementInFrame(this.txtProyecto, this.cuerpoFrame, this.tData.getProyecto());
//	}
//	
...
//		this.wh.clickOnWebElementInFrame(this.rdbMediador, this.cuerpoFrame);
//		// Set Mediador
//		this.wh.clearAndSetTextInWebElementInFrame(this.txtMediador, this.cuerpoFrame, this.tData.getMediador().toString());
//	}
//	
...
//		/*
//		 * // Set Provincia this.wh.SendValueToWebElementInFrameWithJavaScript(this.txtProvincia, this.cuerpoFrame, this.tData.getProvincia()); // Set
//		 * Poblacion this.wh.SendValueToWebElementInFrameWithJavaScript(this.txtPoblacion, this.cuerpoFrame, this.tData.getPoblacion()); // Set Via
//		 * this.wh.SendValueToWebElementInFrameWithJavaScript(this.txtVia, this.cuerpoFrame, this.tData.getNombreVia()); // Set Num Via
//		 * this.wh.SendValueToWebElementInFrameWithJavaScript(this.txtNumVia, this.cuerpoFrame, this.tData.getNumVia());
//		 */
//		
...
//	{
//		this.fillEdificioDireccion(this.tData.getProvincia(), this.tData.getPoblacion(), this.tData.getNombreVia(), this.tData.getNumVia(), null);
//	}
//	
//	public void fillEdificioDireccion(
//			String provincia, String poblacion, String nombreVia, String numVia, String codigoPostal)
//	{
...
//		{
//			// Fill provincia
//			this.wh.sendValueToWebElementInFrame(this.txtProvincia, this.cuerpoFrame, provincia);
//			this.wh.clickOnWebElementInFrame(this.menuItem1, this.cuerpoFrame);
//		}
//		
//		// If text in field "poblacion" is not equals to the poblacion(i) value
...
//		{
//			// Fill poblacion
//			this.wh.sendValueToWebElementInFrame(this.txtPoblacion, this.cuerpoFrame, poblacion);
...
//		{
//			// Fill direccion
//			this.wh.sendValueToWebElementInFrame(this.txtVia, this.cuerpoFrame, nombreVia);
...
//		{
//			// Fill numero
//			this.wh.sendValueToWebElementInFrame(this.txtNumVia, this.cuerpoFrame, numVia);
//		}
//
//		if (codigoPostal != null)
//		{
//			// Fill codigo postal
//			this.wh.sendValueToWebElementInFrame(this.txtPostCod, this.cuerpoFrame, codigoPostal);
//		}
//
...
//		this.wh.clickOnWebElementInFrame(this.rdbEstado, this.cuerpoFrame);
//		// Set Estado
//		this.wh.selectValueInDropDownInFrame(this.cmbEstado, this.cuerpoFrame, this.tData.getEstadoEdificio());
//		
//	}
//	
//	public boolean checkResultadoDireccion()
//	{
//		return this.checkResultadoDireccion(this.wh.getTextFromWebElementInFrame(this.txtPoblacion, this.cuerpoFrame),
//				this.wh.getTextFromWebElementInFrame(this.txtVia, this.cuerpoFrame), this.wh.getTextFromWebElementInFrame(this.txtNumVia, this.cuerpoFrame),
//				null, null);
//	}
//	
//	public boolean checkResultadoDireccion(
//			String poblacion, String nombreVia, String numVia, String refCatastral, String estado)
//	{
...
//		if (poblacion != null)
//		{
//			check = this.wh.webElementInFrameIsPresent(By.xpath(".//td[contains(text(), '" + poblacion + "')]"), this.cuerpoFrame);
//		}
//		
//		if (nombreVia != null)
//		{
//			check = this.wh.webElementInFrameIsPresent(By.xpath(".//td[contains(text(), '" + nombreVia + "')]"), this.cuerpoFrame);
//		}
//		
//		if (numVia != null)
//		{
//			check = this.wh.webElementInFrameIsPresent(By.xpath(".//td[contains(text(), '" + numVia + "')]"), this.cuerpoFrame);
//		}
//		
//		if (refCatastral != null)
//		{
//			check = this.wh.webElementInFrameIsPresent(By.xpath(".//td[contains(text(), '" + refCatastral.toUpperCase() + "')]"), this.cuerpoFrame);
//		}
//		
//		if (estado != null)
//		{
//			check = this.wh.webElementInFrameIsPresent(By.xpath(".//td[contains(text(), '" + estado + "')]"), this.cuerpoFrame);
//		}
//		
...
//		boolean check = false;
//
//		check = this.wh.webElementInFrameIsPresent(this.lblDireccion, this.cuerpoFrame);
//		check = this.wh.webElementInFrameIsPresent(this.lblMediador, this.cuerpoFrame);
//		check = this.wh.webElementInFrameIsPresent(this.lblDatosMediador, this.cuerpoFrame);
//		check = this.wh.webElementInFrameIsPresent(this.lblNumViviendas, this.cuerpoFrame);
//		check = this.wh.webElementInFrameIsPresent(this.lblAntiguedad, this.cuerpoFrame);
//		check = this.wh.webElementInFrameIsPresent(this.lblSuperficie, this.cuerpoFrame);
//
//		logger.debug("END - checkResultado");
//		return check;
//	}
...
//		boolean check = false;
//
//		check = this.wh.webElementInFrameIsPresent(this.tabResumen, this.cuerpoFrame);
//
...
//		boolean check = false;
//
//		check = this.wh.webElementInFrameIsPresent(this.tabPolizas, this.cuerpoFrame);
//
