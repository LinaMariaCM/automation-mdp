...
public class TomadorYAseguradoPage_MAC extends PageObject {
	...
	// private WebElementHelper webDriver;
	// TestCaseData tData;
	//
	// // region webelements
	// @FindBy(name = "cuerpo")
	...
	public void AddDatosTomadorAsegurado() {
		debugBegin();
		if (this.getScenarioVar("tomador").equals(ProjectConstants.NuevoTomadorYAseguradoPrincipal)) {
			...
			//this.webDriver.waitForElementToBeClickableInFrame(this.itemProvincia, this.mainFrame);
