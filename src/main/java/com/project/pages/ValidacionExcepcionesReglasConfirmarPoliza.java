...
{
//	final static Logger logger = LoggerFactory.getLogger(ValidacionExcepcionesReglasConfirmarPoliza.class);
...
//	// endregion
//
//	public ValidacionExcepcionesReglasConfirmarPoliza(BrowserContext browserContext)
//	{
...
//		// if (this.tData.getMotivosSuplemento().containsKey(MutuaPropietariosConstants.MotivoSuplementoInclusionExclusionDescuento)
...
//		this.wh.waitForTwoWebElementsAndCLickOnlyIntheFirstOne(this.btnContinuar, this.btnEmitirSuplemento);
...
//		// catch (Exception e)
//		// {
//		// logger.trace("el botón continuar no ha aparecido en la pantalla de validadcion de excepciones de reglas confirmar poliza", e);
//		// }
//		// }
//		// this.browserContext.webDriverConfiguration.SetWebDriverTimeouts();
