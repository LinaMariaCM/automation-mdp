...
public class DatosBasicosTomadorPage extends PageObject {
	...
	public DatosBasicosTomadorPage fillStaticTomadorData() {
		...
		// this.cuerpoFrame, String.valueOf(this.testDataM.getTomadorDNI()));
		this.webDriver.appendTextInFrame(this.txtNumeroDocumento, this.cuerpoFrame, String.valueOf(this.testDataM.getTestVar(testId, "TomadorDNI")));
	...
	public DatosBasicosTomadorPage fillTomadorData(String tomadorType) throws Exception {
		...
		switch(tomadorType) {
			case ProjectConstants.NuevoTomadorYAseguradoPrincipal:
				...
				this.webDriver.appendTextInFrame(this.txtNombreTomador, this.cuerpoFrame, String.valueOf(this.testDataM.getTestVar(testId, "TomadorNombre")));

				// Select primer apellido
				// this.wh.sendValueToWebElementInFrame(this.txtPrimerApellidoTomador,
				// this.cuerpoFrame,
				// String.valueOf(this.tData.getTomadorPrimerApellido()));
				this.webDriver.appendTextInFrame(this.txtPrimerApellidoTomador, this.cuerpoFrame, String.valueOf(this.testDataM.getTestVar(testId, "tomadorPrimerApellido")));

				// Select segundo apellido
				// this.wh.sendValueToWebElementInFrame(this.txtSegundoApellidoTomador,
				// this.cuerpoFrame,
				// String.valueOf(this.tData.getTomadorSegundoApellido()));
				this.webDriver.appendTextInFrame(this.txtSegundoApellidoTomador, this.cuerpoFrame, String.valueOf(this.testDataM.getTestVar(testId, "TomadorSegundoApellido")));
			...
			case ProjectConstants.ClienteExistente:
				...
				this.testDataM.setTestVar(testId, "TomadorDNI", testDataM.getTestVar(testId, "TomadorDNI"));

				this.webDriver.appendTextInFrame(this.txtNumeroDocumento, this.cuerpoFrame, testDataM.getTestVar(testId, "TomadorDNI"));
				...
				Assert.assertEquals(this.webDriver.getText(this.txtNombreTomador), this.testDataM.getTestVar(testId, "NombreCliente"));
				Assert.assertEquals(this.webDriver.getText(this.txtPrimerApellidoTomador), this.testDataM.getTestVar(testId, "tomadorPrimerApellido"));
				Assert.assertEquals(this.webDriver.getText(this.txtSegundoApellidoTomador), this.testDataM.getTestVar(testId, "TomadorSegundoApellido"));
