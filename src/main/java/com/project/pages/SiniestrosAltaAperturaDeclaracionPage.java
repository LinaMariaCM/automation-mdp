...
public class SiniestrosAltaAperturaDeclaracionPage
{
	final static Logger logger = LoggerFactory.getLogger(SiniestrosAltaAperturaDeclaracionPage.class);
	...
	public SiniestrosAltaAperturaDeclaracionPage(BrowserContext browserContext)
	{
			...
			String fechaOcurrencia)
	{
		...
		this.wh.sendValueToWebElementInFrame(this.txtFechaOcurrencia, this.mainFrame, fechaOcurrencia);
			...
			String tipoDeclarante)
	{
		...
		this.wh.sendValueToWebElementInFrame(this.drpdwnTipoDeclarante, this.mainFrame, tipoDeclarante);
			...
			String medioDeclaracion)
	{
		...
		this.wh.sendValueToWebElementInFrame(this.drpdwnMedioDeclaracion, this.mainFrame, medioDeclaracion);
			...
			String fechaDenuncia)
	{
		...
		this.wh.sendValueToWebElementInFrame(this.txtFechaDenuncia, this.mainFrame, fechaDenuncia);
