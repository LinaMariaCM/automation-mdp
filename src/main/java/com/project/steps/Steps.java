...
//	}
	...
	// ALTA SINIESTRO ALTERNATIVA
		...
		// ALTA SINIESTRO ALTERNATIVA 2
				public void alta_siniestroAlt2(String acceso, String numPoliza, boolean asistencia) throws Exception {
					debugBegin();
					...
					if(acceso.compareTo("Innova") == 0){
						...
						// Buscamos una póliza por Nº póliza
						String ramo = numPoliza.substring(0,3);
