...
import com.mutuaPropietarios.testCasesData.Pages.ClausulasPage;
import com.mutuaPropietarios.testCasesData.Pages.DatosBancariosPage;
import com.mutuaPropietarios.testCasesData.Pages.DatosBasicosTomadorPage;
import com.mutuaPropietarios.testCasesData.Pages.DetallesRiesgoPage;
import com.mutuaPropietarios.testCasesData.Pages.DocumentacionPage;
import com.mutuaPropietarios.testCasesData.Pages.PrecioPage;
import com.mutuaPropietarios.testCasesData.Pages.PrecioPorModalidadPage;
import com.mutuaPropietarios.testCasesData.Pages.TomadorYAseguradoPage;
...
import com.mutuaPropietarios.testCasesData.Pages.ValidacionExcepcionesReglasPage;
import com.mutuaPropietarios.testCasesData.Pages.ValidacionesExcepcionesReglasUbicacionRiesgoPage;
...
public class Steps extends StepObject {
	 ...
	 * numeroCuenta, userS.getTestCaseData().getTestID()));
	 ...
	 * getValuesDataSet(userS.getTestCaseData().gethMapDataSet(),
	 * direccion, // userS.getTestCaseData().getTestID()));
	 ...
	 * getValuesDataSet(userS.getTestCaseData().gethMapDataSet(),
	 * provincia, userS.getTestCaseData().getTestID()));
	 ...
	 * getValuesDataSet(userS.getTestCaseData().gethMapDataSet(),
	 * poblacion, userS.getTestCaseData().getTestID()));
	 ...
	 * getValuesDataSet(userS.getTestCaseData().gethMapDataSet(),
	 * portal, userS.getTestCaseData().getTestID()));
	 ...
	 * userS.getTestCaseData();
	 * setMediador(getValuesDataSet(userS.getTestCaseData().
	 ...
	 * getValuesDataSet(userS.getTestCaseData().gethMapDataSet(),
	 * medioPago, userS.getTestCaseData().getTestID()));
	 ...
	 * getValuesDataSet(userS.getTestCaseData().gethMapDataSet(),
	 * clausula, userS.getTestCaseData().getTestID())); }
	 *
	 ...
	 * getValuesDataSet(userS.getTestCaseData().gethMapDataSet(),
	 * tipo, userS.getTestCaseData().getTestID()));
	 ...
	 * getValuesDataSet(userS.getTestCaseData().gethMapDataSet(),
	 * nombre, userS.getTestCaseData().getTestID()));
	 ...
	 * getValuesDataSet(userS.getTestCaseData().gethMapDataSet(),
	 * apellido, userS.getTestCaseData().getTestID()));
	 ...
	 * getValuesDataSet(userS.getTestCaseData().gethMapDataSet(),
	 * numero, userS.getTestCaseData().getTestID()));
	 ...
	 * getValuesDataSet(userS.getTestCaseData().gethMapDataSet(),
	 * fecha, userS.getTestCaseData().getTestID()));
	 ...
	 * getValuesDataSet(userS.getTestCaseData().gethMapDataSet(),
	 * noCotizacion, userS.getTestCaseData().getTestID()));
	 ...
	 * getValuesDataSet(userS.getTestCaseData().gethMapDataSet(),
	 * noPoliza, userS.getTestCaseData().getTestID()))); }
	 *
	 ...
	 * getValuesDataSet(userS.getTestCaseData().gethMapDataSet(),
	 * causa, userS.getTestCaseData().getTestID())); }
	 *
	 ...
	 * getValuesDataSet(userS.getTestCaseData().gethMapDataSet(),
	 * rol, userS.getTestCaseData().getTestID())); }
	 *
	 ...
	 * getValuesDataSet(userS.getTestCaseData().gethMapDataSet(),
	 * telefono, userS.getTestCaseData().getTestID())); }
	 *
	 ...
	 * .parseInt(getValuesDataSet(userS.getTestCaseData().
	 * gethMapDataSet(), // numeroLocales,
	 * userS.getTestCaseData().getTestID())));
	 ...
	 * userS.getTestCaseData()
	 * .setModifiedM2Viviendas(getValuesDataSet(userS.
	 ...
	 * userS.getTestCaseData()
	 * .setModifiedM2Oficinas(getValuesDataSet(userS.
	 ...
	 * getValuesDataSet(userS.getTestCaseData().gethMapDataSet(),
	 * tomador, userS.getTestCaseData().getTestID())); }
	 *
	 ...
	 * calidadConstruccion) {
	 * userS.getTestCaseData().setCalidadConstruccion(
	 * calidadConstruccion); }
	 *
	 ...
	 * ; userS.getTestCaseData()
	 * .setCapitalContinente(getValuesDataSet(userS.
	 ...
	 * userS.getTestCaseData().setCapitalContenido(
	 * capitalContenido); }
	 *
	 ...
	 * ingresos) { //
	 * userS.getTestCaseData().setIngresosNetosInquilino( //
	 * getValuesDataSet(userS.getTestCaseData().gethMapDataSet(),
	 * ingresos, userS.getTestCaseData().getTestID()) != null // ?
	 * Integer.parseInt( //
	 * getValuesDataSet(userS.getTestCaseData().gethMapDataSet(),
	 * ingresos, userS.getTestCaseData().getTestID())) // : null);
	 * }
	 ...
	 * getValuesDataSet(userS.getTestCaseData().gethMapDataSet(),
	 * nombreAval, userS.getTestCaseData().getTestID())); }
	 *
	 ...
	 * getValuesDataSet(userS.getTestCaseData().gethMapDataSet(),
	 * apellidoAval, userS.getTestCaseData().getTestID())); }
	 *
	 ...
	 * String parentesco) { //
	 * userS.getTestCaseData().setParentescoAval( //
	 * getValuesDataSet(userS.getTestCaseData().gethMapDataSet(),
	 ...
	 * loginAccess) { // Access //
	 * userS.getTestCaseData().setAcceso( //
	 * getValuesDataSet(userS.getTestCaseData().gethMapDataSet(),
	 * loginAccess, userS.getTestCaseData().getTestID())); //
	 * userS.InitializeVariables(userS.
	 * getTestCaseData().getAcceso()); }
	 *
	 * //@Dado("^el usuario \"([^\"]*)\"$") public void inicializo_usuario(
	 * String user) { System.out.println(userS.getFeature()); //
	 * User userS.getTestCaseData().setUsuario(
	 * getValuesDataSet(userS.getTestCaseData().gethMapDataSet(),
	 * user, userS.getTestCaseData().getTestID()));
	 *
	 ...
	 * String tipoProspect) { //
	 * userS.getTestCaseData().setTipoProspect( //
	 * getValuesDataSet(userS.getTestCaseData().gethMapDataSet(),
	 ...
	 * userS.getTestCaseData() //
	 * .setDgs(getValuesDataSet(userS.getTestCaseData().
	 * gethMapDataSet(), dgs,
	 * userS.getTestCaseData().getTestID())); }
	 *
	 ...
	 * getValuesDataSet(userS.getTestCaseData().gethMapDataSet(),
	 * idioma, userS.getTestCaseData().getTestID())); }
	 *
	 ...
	 * userS.webElementHelper.exitFromFrame();
	 ...
	 * // if
	 * (userS.getTestCaseData().getGestionOnlineDisponible().
	 * equals(MutuaPropietariosConstants.LoginAccessInnova)) // { //
	 * org.junit.Assert.assertNotNull(userS.getTestCaseData().
	 ...
	 * (userS.getTestCaseData().isCantidadesModifiedError()) {
	 * throw new AssertionError(userS.getTestCaseData().
	 ...
	 * (userS.getTestCaseData().isCapitalesModifiedError()) {
	 * throw new AssertionError(userS.getTestCaseData().
	 ...
	 * { if (userS.getTestCaseData().isCapitalesModifiedError()) {
	 * throw new AssertionError(userS.getTestCaseData().
	 * getCapitalesModifiedErrorMessage()); } }
	 *
	 ...
	 * getValuesDataSet(userS.getTestCaseData().gethMapDataSet(),
	 * loginAcess, userS.getTestCaseData().getTestID())); //
	 * userS.applicationAccessHelper.LoginAndSearchAutorizacion(
	 * //
	 * getValuesDataSet(userS.getTestCaseData().gethMapDataSet(),
	 * user, userS.getTestCaseData().getTestID()), //
	...
	//MAC DENIEGO EL PROYECTO MAC USANDO ACCESO Y USUARIO
		 ...
		 public void busco_el_proyecto_usando_el_acceso_y_el_usuario(
			 String loginAccess, String user) throws Exception
		 	{
			  ...
			  // Login
			  //userS.initializeVariables(this.userS.getTestVar("acceso"));
			  //userS.applicationAccessHelper.loginAndSearchCotizacion(this.tCData.getUsuario(), userS.getProperties().passwordComun,
			  //this.tCData.getNoCotizacionMAC());
...
//			  this.tCData.getNoCotizacion());  }
			...
			//  userS.applicationAccessHelper.loginAndSearchCotizacion(this.tCData.getUsuario(), userS.getProperties().passwordComun, this.tCData.getNoCotizacion()); // }
...
//			  innovaHomePage.OpenMutuaAlquilerConfort(); }
		...
		public void deberia_aparecer_error_rebasada_la_renta_máxima_permitida()
		  ...
		  { 
			...
			public void doy_de_alta_una_simulacion_y_la_convierto_en_un_proyecto_usando(String loginAcess, String user) throws Throwable
			{				
				this.debugBegin();
					...
					this.login(loginAcess, user);
					  ...
					  if (this.userS.getTestVar("acceso").equals("GestionOnline"))
					  {
						  	new AsignarMediadorPage(userS).selectMediadorAndClickOnContinuar();
					  }   
					  else if(this.userS.getTestVar("acceso").equals("Innova"))
					  {
							AsignarMediadorPage asignarMediadorPage = new AsignarMediadorPage(userS);
							asignarMediadorPage.seleccionarMediadorPorCodigo(getScenarioVar("mediador"));
							asignarMediadorPage.clickOnContinuarButton();
					  }
					...
					datosBasicosTomadorPage.fillTomadorData(getScenarioVar("tomador"));
			...
			public void doy_de_alta_una_simulacion_que_llega_hasta_la_pantalla_de_precio_usando_el_acceso_y_el_usuario(String loginAccess, String user) 
			{
