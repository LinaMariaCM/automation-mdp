...
public class Steps extends InteractionObject {
	 ...
	 * //userS.getTestCaseData().setAsegurarUnicamenteGarajes(true ); }
	 *
	 * // //@Dado("^el dni \"([^\"]*)\"$") public void el_dni( String dniNumber)
	 * { logger.debug("BEGIN - el_dni"); //
	 * userS.getTestCaseData().setTomadorDNI(dniNumber);
	 * logger.debug("END - el_dni"); }
	 *
	 * // //@Dado("^el numero de cuenta es \"([^\"]*)\"$") public void
	 * la_cuenta( String numeroCuenta) { logger.debug("BEGIN - la_cuenta"); //
	 * userS.getTestCaseData().setNumeroCuenta( //
	 * getValuesDataSet(userS.getTestCaseData().gethMapDataSet(), numeroCuenta,
	 * userS.getTestCaseData().getTestID())); logger.debug("END - la_cuenta"); }
	 *
	 ...
	 * userS.getTestCaseData().setFechaContratoAlquiler(fecha);
	 ...
	 * userS.getTestCaseData().setInmueble(
	 * getValuesDataSet(userS.getTestCaseData().gethMapDataSet(), direccion, //
	 * userS.getTestCaseData().getTestID())); logger.debug("END - el_inmueble");
	 * }
	 *
	 * //@Dado("^la provincia del inmueble es \"([^\"]*)\"$") public void
	 * provincia_inmueble( String provincia) {
	 * logger.debug("BEGIN - provincia_inmueble"); //
	 * userS.getTestCaseData().setInmuebleProvincia( //
	 * getValuesDataSet(userS.getTestCaseData().gethMapDataSet(), provincia,
	 ...
	 * userS.getTestCaseData().setInmueblePoblacion( //
	 * getValuesDataSet(userS.getTestCaseData().gethMapDataSet(), poblacion,
	 * userS.getTestCaseData().getTestID()));
	 ...
	 * userS.getTestCaseData().setInmuebleNombreVia( //
	 * getValuesDataSet(userS.getTestCaseData().gethMapDataSet(), direccion,
	 * userS.getTestCaseData().getTestID()));
	 ...
	 * userS.getTestCaseData().setInmuebleNumeroVia( //
	 * getValuesDataSet(userS.getTestCaseData().gethMapDataSet(), portal,
	 * userS.getTestCaseData().getTestID()));
	 ...
	 * .setNumeroEdificios(getValuesDataSet(userS.getTestCaseData(
	 * ).gethMapDataSet(), numeroEdificios, //
	 * userS.getTestCaseData().getTestID()) != null ? //
	 * Integer.parseInt(getValuesDataSet(userS.getTestCaseData().
	 * gethMapDataSet(), numeroEdificios, //
	 * userS.getTestCaseData().getTestID())) : null);
	 ...
	 * userS.getTestCaseData();
	 * setMediador(getValuesDataSet(userS.getTestCaseData(). gethMapDataSet(),
	 * codigoMediador, // userS.getTestCaseData().getTestID()) != null ? //
	 * Integer.parseInt(getValuesDataSet(userS.getTestCaseData().
	 ...
	 * userS.getTestCaseData().setMedioPago( //
	 * getValuesDataSet(userS.getTestCaseData().gethMapDataSet(), medioPago,
	 * userS.getTestCaseData().getTestID()));
	 ...
	 * userS.getTestCaseData().setModificarClausulas(
	 * ProjectConstants.ModificarClausulas);
	 * userS.getTestCaseData().setClausulas(
	 * getValuesDataSet(userS.getTestCaseData().gethMapDataSet(), clausula,
	 * userS.getTestCaseData().getTestID())); }
	 *
	 ...
	 * el_asegurado_es_diferente_del_tomador() { userS.getTestCaseData().
	 ...
	 * userS.getTestCaseData().setTipoPersona(
	 * getValuesDataSet(userS.getTestCaseData().gethMapDataSet(), tipo,
	 * userS.getTestCaseData().getTestID()));
	 * logger.debug("END - tipo_de_persona"); }
	 *
	 * //@Dado("^el documento de tomador es aleatoreo$") public void
	 * el_documento_tomador_es_aleatoreo() {
	 * userS.getTestCaseData().setTomadorDocumento(
	 ...
	 * userS.getTestCaseData().setTomadorDocumento(
	 * getValuesDataSet(userS.getTestCaseData().gethMapDataSet(), documento,
	 * userS.getTestCaseData().getTestID()));
	 * logger.debug("BEGIN - documento_tomador"); }
	 *
	 * //@Dado("^el nombre de tomador es \"([^\"]*)\"$") public void
	 * nombre_tomador( String nombre) { logger.debug("BEGIN - nombre_tomador");
	 * // userS.getTestCaseData().setTomadorNombre( //
	 * getValuesDataSet(userS.getTestCaseData().gethMapDataSet(), nombre,
	 * userS.getTestCaseData().getTestID()));
	 ...
	 * userS.getTestCaseData().setTomadorPrimerApellido( //
	 * getValuesDataSet(userS.getTestCaseData().gethMapDataSet(), apellido,
	 * userS.getTestCaseData().getTestID()));
	 ...
	 * userS.getTestCaseData().setProvincia( //
	 * getValuesDataSet(userS.getTestCaseData().gethMapDataSet(), provincia,
	 * userS.getTestCaseData().getTestID()));
	 ...
	 * userS.getTestCaseData().setPoblacion( //
	 * getValuesDataSet(userS.getTestCaseData().gethMapDataSet(), poblacion,
	 * userS.getTestCaseData().getTestID()));
	 ...
	 * userS.getTestCaseData().setNombreVia( //
	 * getValuesDataSet(userS.getTestCaseData().gethMapDataSet(), direccion,
	 * userS.getTestCaseData().getTestID()));
	 ...
	 * userS.getTestCaseData().setNumVia( //
	 * getValuesDataSet(userS.getTestCaseData().gethMapDataSet(), numero,
	 * userS.getTestCaseData().getTestID()));
	 ...
	 * userS.getTestCaseData().setTomadorProvincia( //
	 * getValuesDataSet(userS.getTestCaseData().gethMapDataSet(), provincia,
	 * userS.getTestCaseData().getTestID()));
	 * logger.debug("END - provincia_tomador"); }
	 *
	 ...
	 * userS.getTestCaseData().setTomadorPoblacion( //
	 * getValuesDataSet(userS.getTestCaseData().gethMapDataSet(), poblacion,
	 * userS.getTestCaseData().getTestID()));
	 * logger.debug("END - poblacion_tomador"); }
	 *
	 ...
	 * userS.getTestCaseData().setTomadorDireccion( //
	 * getValuesDataSet(userS.getTestCaseData().gethMapDataSet(), direccion,
	 * userS.getTestCaseData().getTestID()));
	 * logger.debug("END - direccion_tomador"); }
	 *
	 ...
	 * logger.debug("BEGIN - numero_portal_tomador"); //
	 * userS.getTestCaseData().setTomadorNumeroPortal( //
	 * getValuesDataSet(userS.getTestCaseData().gethMapDataSet(), numero,
	 * userS.getTestCaseData().getTestID()));
	 * logger.debug("END - numero_portal_tomador"); }
	 *
	 ...
	 * userS.getTestCaseData().setTomadorFechaNacimiento( //
	 * getValuesDataSet(userS.getTestCaseData().gethMapDataSet(), fecha,
	 * userS.getTestCaseData().getTestID()));
	 ...
	 * userS.getTestCaseData().setAddFile(true); }
	 *
	 ...
	 * userS.getTestCaseData().setReferenciaCatastral(
	 * getValuesDataSet(userS.getTestCaseData().gethMapDataSet(), //
	 * referenciaCatastral, userS.getTestCaseData().getTestID()));
	 ...
	 * userS.getTestCaseData().setNoCotizacion( //
	 * getValuesDataSet(userS.getTestCaseData().gethMapDataSet(), noCotizacion,
	 * userS.getTestCaseData().getTestID()));
	 ...
	 * userS.getTestCaseData() //
	 * .setNumeroViviendas(getValuesDataSet(userS.getTestCaseData(
	 ...
	 * userS.getTestCaseData().setM2Vivienda(m2Viviendas);
	 ...
	 * userS.getTestCaseData().setM2Garajes(m2Garajes);
	 ...
	 * userS.getTestCaseData().setAnyoConstruccion( ProjectConstants.MayorDe50);
	 * } else { userS.getTestCaseData().setAnyoConstruccion(
	 * getValuesDataSet(userS.getTestCaseData().gethMapDataSet(),
	 * anyoConstruccion, userS.getTestCaseData().getTestID())); } }
	 *
	 ...
	 * getValuesDataSet(userS.getTestCaseData().gethMapDataSet(), noPoliza,
	 * userS.getTestCaseData().getTestID()))); }
	 *
	 * //@Dado("^fecha de siniestro es \"([^\"]*)\"$") public void
	 * fecha_siniestro_es( String fecha) {
	 * userS.getTestCaseData().setFechaSiniestro(
	 * getValuesDataSet(userS.getTestCaseData().gethMapDataSet(), fecha,
	 * userS.getTestCaseData().getTestID())); }
	 *
	 * //@Dado("^causa de siniestro es \"([^\"]*)\"$") public void
	 * causa_siniestro_es( String causa) {
	 * userS.getTestCaseData().setCausaSiniestro(
	 * getValuesDataSet(userS.getTestCaseData().gethMapDataSet(), causa,
	 * userS.getTestCaseData().getTestID())); }
	 *
	 * //@Dado("^rol de la persona de contacto es \"([^\"]*)\"$") public void
	 * rol_persona_contacto_es( String rol) {
	 * userS.getTestCaseData().setRolPersonaContacto(
	 * getValuesDataSet(userS.getTestCaseData().gethMapDataSet(), rol,
	 * userS.getTestCaseData().getTestID())); }
	 *
	 * //@Dado("^nombre de la persona de contacto es \"([^\"]*)\"$") public void
	 * nombre_persona_contacto_es( String nombre) {
	 * userS.getTestCaseData().setNombrePersonaContacto(
	 * getValuesDataSet(userS.getTestCaseData().gethMapDataSet(), nombre,
	 * userS.getTestCaseData().getTestID())); }
	 *
	 * //@Dado("^apellido de la persona de contacto es \"([^\"]*)\"$") public
	 * void apellido_persona_contacto_es( String apellido) {
	 * userS.getTestCaseData().setApellidoPersonaContacto(
	 * getValuesDataSet(userS.getTestCaseData().gethMapDataSet(), apellido,
	 * userS.getTestCaseData().getTestID())); }
	 *
	 * //@Dado("^telefono de la persona de contacto es \"([^\"]*)\"$") public
	 * void telefono_persona_contacto_es( String telefono) {
	 * userS.getTestCaseData().setTelefonoPersonaContacto(
	 * getValuesDataSet(userS.getTestCaseData().gethMapDataSet(), telefono,
	 * userS.getTestCaseData().getTestID())); }
	 *
	 * //@Dado("^descripcion de siniestro es \"([^\"]*)\"$") public void
	 * descripcion_siniestro_es( String descripcion) {
	 * userS.getTestCaseData().setDescripcionSiniestro(
	 * getValuesDataSet(userS.getTestCaseData().gethMapDataSet(), descripcion,
	 * userS.getTestCaseData().getTestID())); }
	 *
	 ...
	 * userS.getTestCaseData().setNumPoliza(datosBancariosPage.
	 * GetPolizaNumber()); }
	 *
	 ...
	 * userS.getTestCaseData().setCambioMedioPago( //
	 * getValuesDataSet(userS.getTestCaseData().gethMapDataSet(), medioPago,
	 * userS.getTestCaseData().getTestID()));
	 ...
	 * (getValuesDataSet(userS.getTestCaseData().gethMapDataSet(), //
	 * numeroViviendas, userS.getTestCaseData().getTestID()))); //
	 * userS.getTestCaseData().setNumeroViviendas(numeroViviendas) ;
	 ...
	 * (getValuesDataSet(userS.getTestCaseData().gethMapDataSet(), //
	 * numeroEdificios, userS.getTestCaseData().getTestID())));
	 ...
	 * userS.getTestCaseData().setNumeroLocalesComerciales(Integer
	 * .parseInt(getValuesDataSet(userS.getTestCaseData(). gethMapDataSet(), //
	 * numeroLocales, userS.getTestCaseData().getTestID())));
	 ...
	 * userS.getTestCaseData() .setModifiedM2Viviendas(getValuesDataSet(userS.
	 * getTestCaseData().gethMapDataSet(), m2Viviendas,
	 * userS.getTestCaseData().getTestID()) != null ?
	 * Integer.parseInt(getValuesDataSet(userS.getTestCaseData().
	 * gethMapDataSet(), m2Viviendas, userS.getTestCaseData().getTestID())) :
	 * null); }
	 *
	 * //@Cuando("^cambio los valores de m2 zonas ajardinadas a \"([^\"]*)\"$")
	 * public void cambio_los_valores_de_m_zonas_ajardinadas_a( String
	 * m2ZonasAjardinadas) { userS.getTestCaseData()
	 * .setModifiedM2ZonasAjardinadas(getValuesDataSet(userS.
	 ...
	 * userS.getTestCaseData() .setModifiedM2Oficinas(getValuesDataSet(userS.
	 * getTestCaseData().gethMapDataSet(), m2Oficinas,
	 * userS.getTestCaseData().getTestID()) != null ?
	 * Integer.parseInt(getValuesDataSet(userS.getTestCaseData().
	 * gethMapDataSet(), m2Oficinas, userS.getTestCaseData().getTestID())) :
	 * null); }
	 *
	 ...
	 * userS.getTestCaseData().setModifiedM2Garajes(
	 * getValuesDataSet(userS.getTestCaseData().gethMapDataSet(), m2Garajes,
	 * userS.getTestCaseData().getTestID()) != null ?
	 * Integer.parseInt(getValuesDataSet(userS.getTestCaseData().
	 * gethMapDataSet(), m2Garajes, userS.getTestCaseData().getTestID())) :
	 * null); }
	 *
	 * //@Cuando("^cambio el año construcción a \"([^\"]*)\"$$") public void
	 * cambio_el_anyo_construccion_a( String anyoConstruccion) { //
	 * userS.getTestCaseData().setAnyoConstruccion(
	 * getValuesDataSet(userS.getTestCaseData().gethMapDataSet(), //
	 * anyoConstruccion, userS.getTestCaseData().getTestID())); }
	 *
	 * //@
	 ...
	 * Integer anyoRehabilicion) { // userS.getTestCaseData().
	 ...
	 * String nivelRehabilitacion) { // userS.getTestCaseData().
	 ...
	 * userS.getTestCaseData().setAnyoRehabilitacionIntegral(
	 * anyoRehabilitacionIntegral); }
	 *
	 * //@Cuando("^selecciono Hay una gasolinera a menos de '(\\d+)'$") public
	 * void selecciono_Hay_una_gasolinera_a_menos_de_m( int arg1) {
	 ...
	 * userS.getTestCaseData().setMotivosSuplemento(false, motivoSuplemento); }
	 *
	 * //@Cuando("^selecciono como tomador \"([^\"]*)\"$") public void
	 * selecciono_como_tomador( String tomador) { //
	 * userS.getTestCaseData().setTomador( //
	 * getValuesDataSet(userS.getTestCaseData().gethMapDataSet(), tomador,
	 * userS.getTestCaseData().getTestID())); }
	 *
	 * //@Cuando("^se modifica el año de construcción a \"([^\"]*)\"$") public
	 * void se_modifica_el_año_de_construcción( String anyoConstruccion) {
	 * userS.getTestCaseData().setAnyoConstruccion( anyoConstruccion); }
	 *
	 ...
	 * calidadConstruccion) { userS.getTestCaseData().setCalidadConstruccion(
	 * calidadConstruccion); }
	 *
	 ...
	 * userS.getTestCaseData().setCapitalContinenteVariacion(true) ;
	 * userS.getTestCaseData() .setCapitalContinente(getValuesDataSet(userS.
	 ...
	 * userS.getTestCaseData().setFranquiciaVoluntaria(
	 * getValuesDataSet(userS.getTestCaseData().gethMapDataSet(), //
	 * franquiciaVoluntaria, userS.getTestCaseData().getTestID())); //
	 ...
	 * String descuento) { // userS.getTestCaseData().setDescuento(descuento); }
	 *
	 ...
	 * userS.getTestCaseData().setCapitalContenido( capitalContenido); }
	 *
	 ...
	 * userS.getTestCaseData() //
	 * .setRentaMensualAlquiler(getValuesDataSet(userS.
	 ...
	 * ingresos) { // userS.getTestCaseData().setIngresosNetosInquilino( //
	 * getValuesDataSet(userS.getTestCaseData().gethMapDataSet(), ingresos,
	 * userS.getTestCaseData().getTestID()) != null // ? Integer.parseInt( //
	 * getValuesDataSet(userS.getTestCaseData().gethMapDataSet(), ingresos,
	 * userS.getTestCaseData().getTestID())) // : null); }
	 *
	 * //@Dado("^suma asegurada es \"([^\"]*)\"$") public void suma_asegurada(
	 * String sumaAsegurada) { // userS.getTestCaseData().setImpagoAlquiler( //
	 * getValuesDataSet(userS.getTestCaseData().gethMapDataSet(), sumaAsegurada,
	 * userS.getTestCaseData().getTestID())); }
	 *
	 * //@Dado("^franquicia es \"([^\"]*)\"$") public void franquiciaMAC( String
	 * franquiciaMAC) { // userS.getTestCaseData().setFranquiciaMAC( //
	 * getValuesDataSet(userS.getTestCaseData().gethMapDataSet(), franquiciaMAC,
	 * userS.getTestCaseData().getTestID())); }
	 *
	 * //@Dado("^los ingresos aval \"([^\"]*)\"$") public void
	 * los_ingresos_aval( String ingresosAval) { // userS.getTestCaseData() //
	 * .setIngresosAval(getValuesDataSet(userS.getTestCaseData().
	 * gethMapDataSet(), ingresosAval, // userS.getTestCaseData().getTestID())
	 * != null // ? Integer.parseInt(getValuesDataSet(userS.getTestCaseData().
	 * gethMapDataSet(), ingresosAval, // userS.getTestCaseData().getTestID()))
	 * // : null); }
	 *
	 * //@Dado("^el documento aleatoreo$") public void el_documento_aleatoreo()
	 * { userS.getTestCaseData().setDocumentoInquilino(
	 * DniGeneratorHelper.generaNif(null)); }
	 *
	 * //@Dado("^el documento \"([^\"]*)\"$") public void el_documento( String
	 * documento) { // userS.getTestCaseData().setDocumentoInquilino( //
	 * getValuesDataSet(userS.getTestCaseData().gethMapDataSet(), documento,
	 * userS.getTestCaseData().getTestID())); }
	 *
	 * //@Dado("^el documento aval \"([^\"]*)\"$") public void
	 * el_documento_aval( String documentoAval) { //
	 * userS.getTestCaseData().setDocumentoAval( //
	 * getValuesDataSet(userS.getTestCaseData().gethMapDataSet(), documentoAval,
	 * userS.getTestCaseData().getTestID())); }
	 *
	 * //@Dado("^el nombre del inquilino \"([^\"]*)\"$") public void
	 * el_nombre_del_inquilino( String nombre) { //
	 * userS.getTestCaseData().setNombreInquilino( //
	 * getValuesDataSet(userS.getTestCaseData().gethMapDataSet(), nombre,
	 * userS.getTestCaseData().getTestID())); }
	 *
	 * //@Dado("^el nombre de aval \"([^\"]*)\"$") public void
	 * el_nombre_de_aval( String nombreAval) { //
	 * userS.getTestCaseData().setNombreAval( //
	 * getValuesDataSet(userS.getTestCaseData().gethMapDataSet(), nombreAval,
	 * userS.getTestCaseData().getTestID())); }
	 *
	 * //@Dado("el primer apellido del inquilino \"([^\"]*)\"$") public void
	 * el_primer_apellido_del_inquilino( String apellido) { //
	 * userS.getTestCaseData().setPrimerApellidoInquilino( //
	 * getValuesDataSet(userS.getTestCaseData().gethMapDataSet(), apellido,
	 * userS.getTestCaseData().getTestID())); }
	 *
	 * //@Dado("el primer apellido del aval \"([^\"]*)\"$") public void
	 * el_primer_apellido_del_aval( String apellidoAval) { //
	 * userS.getTestCaseData().setPrimerApellidoAval( //
	 * getValuesDataSet(userS.getTestCaseData().gethMapDataSet(), apellidoAval,
	 * userS.getTestCaseData().getTestID())); }
	 *
	 ...
	 * String parentesco) { // userS.getTestCaseData().setParentescoAval( //
	 * getValuesDataSet(userS.getTestCaseData().gethMapDataSet(), parentesco,
	 * userS.getTestCaseData().getTestID())); }
	 *
	 ...
	 * userS.getTestCaseData().setSituacionLaboralInquilino(
	 * getValuesDataSet(userS.getTestCaseData().gethMapDataSet(), //
	 * situacionLaboralAval, userS.getTestCaseData().getTestID())); }
	 *
	 * //@Dado("^el acceso \"([^\"]*)\"$") public void inicializo_acceso( String
	 * loginAccess) { // Access // userS.getTestCaseData().setAcceso( //
	 * getValuesDataSet(userS.getTestCaseData().gethMapDataSet(), loginAccess,
	 * userS.getTestCaseData().getTestID())); //
	 * userS.InitializeVariables(userS. getTestCaseData().getAcceso()); }
	 *
	 * //@Dado("^el usuario \"([^\"]*)\"$") public void inicializo_usuario(
	 * String user) { System.out.println(userS.getFeature()); // User
	 * userS.getTestCaseData().setUsuario(
	 * getValuesDataSet(userS.getTestCaseData().gethMapDataSet(), user,
	 * userS.getTestCaseData().getTestID()));
	 *
	 * // userS.applicationAccessHelper.Login(userS.
	 * getTestCaseData().getUsuario(), // userS.GetProperties().passwordComun);
	 * }
	 *
	 ...
	 * userS.getTestCaseData().setFiltroBuscadorEdificio(
	 * getValuesDataSet(userS.getTestCaseData().gethMapDataSet(),
	 ...
	 * userS.getTestCaseData().setNivelEstructura( //
	 * getValuesDataSet(userS.getTestCaseData().gethMapDataSet(),
	 * nivelEstructura, userS.getTestCaseData().getTestID())); }
	 *
	 * //@Dado("^tipo prospect es \"([^\"]*)\"$") public void tipo_prospect(
	 * String tipoProspect) { // userS.getTestCaseData().setTipoProspect( //
	 * getValuesDataSet(userS.getTestCaseData().gethMapDataSet(), tipoProspect,
	 * userS.getTestCaseData().getTestID())); }
	 *
	 * //@Dado("^el tipo mediador es \"([^\"]*)\"$") public void tipo_mediador(
	 * String tipoMediador) { // userS.getTestCaseData().setTipoProspect( //
	 * getValuesDataSet(userS.getTestCaseData().gethMapDataSet(), tipoProspect,
	 * userS.getTestCaseData().getTestID())); }
	 *
	 * //@Dado("^numero registro DGS es \"([^\"]*)\"$") public void
	 * numero_resigtro_dgs( String dgs) { // userS.getTestCaseData() //
	 * .setDgs(getValuesDataSet(userS.getTestCaseData(). gethMapDataSet(), dgs,
	 * userS.getTestCaseData().getTestID())); }
	 *
	 * //@Dado("^la actividad principal es \"([^\"]*)\"$") public void
	 * actividad_principal( String actividadPrincipal) { //
	 * userS.getTestCaseData().setActividadPrincipal(
	 * getValuesDataSet(userS.getTestCaseData().gethMapDataSet(), //
	 ...
	 * userS.getTestCaseData().setNombreComercial( //
	 * getValuesDataSet(userS.getTestCaseData().gethMapDataSet(),
	 * nombreComercial, userS.getTestCaseData().getTestID())); }
	 *
	 ...
	 * userS.getTestCaseData().setContactoResponsable(
	 * getValuesDataSet(userS.getTestCaseData().gethMapDataSet(), //
	 * contactoResponsable, userS.getTestCaseData().getTestID())); }
	 *
	 * //@Dado("^idioma es \"([^\"]*)\"$") public void idioma( String idioma) {
	 * // userS.getTestCaseData().setIdioma( //
	 * getValuesDataSet(userS.getTestCaseData().gethMapDataSet(), idioma,
	 * userS.getTestCaseData().getTestID())); }
	 *
	 * //@Dado("^telefono principal es \"([^\"]*)\"$") public void
	 * telefono_principal( String tlfPrincipal) { //
	 * userS.getTestCaseData().setTlfPrincipal( //
	 * getValuesDataSet(userS.getTestCaseData().gethMapDataSet(), tlfPrincipal,
	 * userS.getTestCaseData().getTestID())); }
	 *
	 * //@Dado("^ejecutivo comercial es \"([^\"]*)\"$") public void
	 * ejecutivo_comercial( String ejecutivoComercial) { //
	 * userS.getTestCaseData().setEjecutivoComercial(
	 * getValuesDataSet(userS.getTestCaseData().gethMapDataSet(), //
	 ...
	 * userS.applicationAccessHelper.LoginAndCreateSimulation(this
	 ...
	 * userS.writeTestCaseData(); logger.
	 ...
	 *
	 *
	 * public ActionsSteps(BrowserContext browserContext) { userS =
	 * browserContext; this.tCData = userS.getTestCaseData(); }
	 *
	 ...
	 *
	 * // Login userS.initializeVariables(loginAcess =
	 ...
	 * .tCData.getCambioUsuario(), userS.getProperties().passwordComun,
	 ...
	 * userS.writeTestCaseData(); userS.getWebDriver().quit(); logger.
	 ...
	 *
	 * if (loginAcess.equals(ProjectConstants.LoginAccessGestionLine) &&
	 * userS.getProperties().GestionOnlineDisponible.equals(
	 ...
	 * loginAcess.equals(ProjectConstants.LoginAccessInnova)) {
	 * userS.initializeVariables(loginAcess);
	 * userS.applicationAccessHelper.LoginAndCreateProjectMEC(this
	 * .tCData.getUsuario(), userS.getProperties().passwordComun);
	 * AsignarMediadorPage asignarMediadorPage = new AsignarMediadorPage(userS);
	 * asignarMediadorPage.selectMediadorAndClickOnContinuar();
	 * UbicacionRiesgoPage ubicacionRiesgoPage = new UbicacionRiesgoPage(userS);
	 ...
	 * String loginAcess, String user) { userS.initializeVariables(loginAcess =
	 * this.userS.getTestVar("acceso")); userS.applicationAccessHelper.
	 * LoginAndSearchPolizaByPolizaNumber(this.tCData.getUsuario(),
	 * userS.getProperties().passwordComun,
	 * String.valueOf(this.tCData.getNumPoliza())); }
	 *
	 ...
	 * String loginAcess, String user) { userS.initializeVariables(loginAcess =
	 * this.userS.getTestVar("acceso"));
	 * userS.applicationAccessHelper.LoginAndSearchPolizaByNifNie(
	 * this.tCData.getUsuario(), userS.getProperties().passwordComun,
	 ...
	 * userS.applicationAccessHelper.loginAndSearchCotizacion(this
	 * .tCData.getUsuario(), userS.getProperties().passwordComun,
	 * this.tCData.getNoCotizacion()); // userS.initializeVariables(loginAcess =
	 * this.tCData.getCambioAcceso()); //
	 * userS.applicationAccessHelper.loginAndSearchCotizacion(this
	 * .tCData.getCambioUsuario(), // userS.getProperties().passwordComun, //
	 ...
	 * tomadorYAseguradoPage_MAC = new TomadorYAseguradoPage_MAC(userS);
	 ...
	 * userS.getWebDriver().quit(); logger.
	 ...
	 * GestionLine userS.initializeVariables(loginAcess =
	 * this.userS.getTestVar("acceso")); //
	 * userS.applicationAccessHelper.LoginAndCreateProjectMAC(this
	 * .tCData.getUsuario(), // userS.getProperties().passwordComun);
	 *
	 ...
	 * else if (loginAcess.equals(ProjectConstants.LoginAccessInnova)) {
	 *
	 * // Login to Innov@ userS.initializeVariables(loginAcess =
	 * this.userS.getTestVar("acceso"));
	 * userS.applicationAccessHelper.loginAndSearchCotizacion(this
	 * .tCData.getUsuario(), userS.getProperties().passwordComun,
	 * this.tCData.getNoCotizacionMAC());
	 ...
	 *
	 * // SCS Inquilinos InquilinosAvalistasPage_MAC inquilinosAvalistasPage_MAC
	 * = new InquilinosAvalistasPage_MAC(userS); inquilinosAvalistasPage_MAC.
	 ...
	 * // Login userS.initializeVariables(loginAcess =
	 * this.userS.getTestVar("acceso"));
	 * userS.applicationAccessHelper.login(this.tCData.getUsuario( ),
	 * userS.getProperties().passwordComun);
	 *
	 ...
	 * address + "\n"; writeFile(fileName + " (log file).txt", logText);
	 * System.out.println("Comprobaciones de datos no contempladas\n\t- " +
	 * e.toString()); userS.webElementHelper.exitFromFrame();
	 * innovaHomePage.openInnovaHome();
	 * innovaHomePage.openMutuaEdificioConfort(); } }
	 *
	 * userS.getWebDriver().quit();
	 ...
	 * "nombreVia", i));
	 *
	 * try { userS.initializeVariables(loginAcess =
	 * this.userS.getTestVar("acceso"));
	 * userS.applicationAccessHelper.login(this.tCData.getUsuario( ),
	 * userS.getProperties().passwordComun);
	 *
	 ...
	 *
	 *
	 * public ChecksSteps(BrowserContext browserContext) { userS =
	 ...
	 * FichaEdificioPage fichaEdificioPage = new FichaEdificioPage(webDriver,
	 * userS.getTestDataManager());
	 * org.testng.Assert.assertTrue(fichaEdificioPage.
	 * checkPestanaResumenVisible( ));
	 *
	 ...
	 * userS.getTestDataManager());
	 * org.testng.Assert.assertTrue(clientePage.checkResultadoNIF()); // TODO
	 ...
	 * // if (userS.getTestCaseData().getGestionOnlineDisponible().
	 * equals(MutuaPropietariosConstants.LoginAccessInnova)) // { //
	 * org.testng.Assert.assertNotNull(userS.getTestCaseData().
	 ...
	 * (userS.getTestCaseData().isCantidadesModifiedError()) { throw new
	 * AssertionError(userS.getTestCaseData().
	 ...
	 * (userS.getTestCaseData().isCapitalesModifiedError()) { throw new
	 * AssertionError(userS.getTestCaseData().
	 ...
	 * { if (userS.getTestCaseData().isCapitalesModifiedError()) { throw new
	 * AssertionError(userS.getTestCaseData().
	 * getCapitalesModifiedErrorMessage()); } }
	 *
	 ...
	 * ValidacionExcepcionesReglasDetallesRiesgoPage( userS); boolean check =
	 * false;
	 *
	 ...
	 * userS.applicationAccessHelper.OpenGestionPolizas();
	 * GestionPolizasBuscadorPage gestionPolizasBuscadorPage = new
	 * GestionPolizasBuscadorPage(userS);
	 * gestionPolizasBuscadorPage.SearchPolizaByPolizaNumber(String.valueOf(this
	 * .browserContext.getTestCaseData().getNumPoliza()));
	 ...
	 *
	 * // Login // userS.initializeVariables( //
	 * getValuesDataSet(userS.getTestCaseData().gethMapDataSet(), loginAcess,
	 * userS.getTestCaseData().getTestID())); //
	 * userS.applicationAccessHelper.LoginAndSearchAutorizacion( //
	 * getValuesDataSet(userS.getTestCaseData().gethMapDataSet(), user,
	 * userS.getTestCaseData().getTestID()), //
	 ...
	 * userS.initializeVariables(this.tCData.getAccesoAuth());
	 * userS.applicationAccessHelper.LoginAndSearchAutorizacion(
	 * this.tCData.getUsuarioAuth(), userS.getProperties().passwordComun);
	 *
	 * // Abrir la busqueda de autorizaciones InnovaHomePage innovaHomePage =
	 ...
	 * GestionAutorizacionesPage(webDriver, userS.getTestDataManager());
	 * gestionAutorizacionesPage.buscarAutorizaciones("Proceso de cotización",
	 * "Pendiente de autorizar", userS.getTestCaseData().getNoCotizacionMAC());
	 *
	 * // Autorizar el proyecto gestionAutorizacionesPage.autorizar();
	 ...
	 * { PrecioPorModalidadPage_MAC precioPorModalidadPage_MAC = new
	 * PrecioPorModalidadPage_MAC(userS); // Comprobar que sale el error
	 * correspondiente Assert.assertTrue(
	 ...
	 * PrecioPorModalidadPage_MAC precioPorModalidadPage_MAC = new
	 * PrecioPorModalidadPage_MAC(userS); // Comprobar que se queda
	 * deshabilitado Convertir a proyecto
...
*/
	...
	public void doy_de_alta_un_proyecto_que_llega_hasta_la_pantalla_de_contratacion_usando_el_acceso_y_el_usuario(
		...
		this.login(loginAccess, user);
		 ...
		 if(getScenarioVar("acceso").equals(ProjectConstants.LoginAccessGestionLine)) 
		 { // GestionOnlineHomePage

			 new GestionOnlineHomePage(userS).openContratarMutuaAlquilerConfort();
			 
		 } else if(getScenarioVar("acceso").equals(ProjectConstants.LoginAccessInnova))
		 	{
				new AsignarMediadorPage(userS).SelectMediadorMACAndClickOnContinuar(); 
				new InnovaHomePage(userS).OpenMutuaAlquilerConfort(); 
		 	}
...
//				  LoginAndSearchPolizaByPolizaNumber(this.tCData.getCambioUsuario(),userS.getProperties().passwordComun,String.valueOf(this.tCData.getNumPoliza()));
	...
	public void doy_de_alta_una_simulacion_MEC_que_llega_hasta_la_pantalla_de_detalles_de_riesgo_usando_el_acceso_y_el_usuario(String loginAccess, String user) throws Exception {
		...
		if (loginAccess.equals(ProjectConstants.LoginAccessGestionLine) && getConfigVar("GestionOnlineDisponible").equals(ProjectConstants.GestionOnlineDisponible) || loginAccess.equals(ProjectConstants.LoginAccessInnova)) {
