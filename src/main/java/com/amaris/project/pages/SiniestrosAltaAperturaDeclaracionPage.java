...
public class SiniestrosAltaAperturaDeclaracionPage extends PageObject {
	...
	public void altaDatosBasicos(String tipoDeclarante, String medioDeclaracion) {
		...
		this.webDriver.clickElementFromDropDownByAttribute(this.comboTipoDeclarante, "value", tipoDeclarante);// Añadir
																												// los
																												// tipos
																												// de
																												// value
	...
	public void altaDatosDeclarante(String nombreDeclarante, String apellidoDeclarante, String segundoApellido, String prefijoTelefono, String numeroTelefono, String emailDeclarante,
		...
		this.webDriver.clickElementFromDropDownByAttribute(this.comboPrefijo, "value", prefijoTelefono);// Añadir
																										// los
																										// tipos
																										// de
																										// value
	...
	public void altaOtrosDatos(String estructuraAfectada, String instalacionesAfectadas, String referenciaMediador, boolean carpetaFisica) {
		...
		this.webDriver.clickElementFromDropDownByAttribute(this.comboElementoAfectado, "value", estructuraAfectada);// Añadir
																													// los
																													// tipos
																													// de
																													// value
																													// como
																													// comentario
		this.webDriver.clickElementFromDropDownByAttribute(this.comboInstalacionAfectada, "value", instalacionesAfectadas);// Añadir
																															// los
																															// tipos
																															// de
																															// value
	...
	// Minimos TEST ZERO
	public void completarMinimos(String numPoliza) // método que completa el
													// mínimo de campos para
													// realizar una prueba
	{
		...
		// if(numPoliza.substring(0, 3).compareTo("510") == 0 ||
		// numPoliza.substring(0, 3).compareTo("500") == 0)
		// this.webDriver.click(this.rdbtnAsistenciaNo);
