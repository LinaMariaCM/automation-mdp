...
public class AltaEventoSiniestrosPage extends PageObject {
	...
	private By causa = By.cssSelector("#nombdato_nombdato_TIPOCAUSA_1_0"); // el ultimo numero indica el orden que esta.
																			// el ultimos es 458.
	...
	public AltaEventoSiniestrosPage(UserStory userS) {
		super(userS);
	}
