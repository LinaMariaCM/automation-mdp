...
public class DiarioSiniestrosPage extends PageObject {
	...
	public boolean comprobar_siniestro_reconsiderado() {
		...
		if(reconsiderado) {
			System.out.println("Siniestro reconsiderado");
		}
	...
	public DiarioSiniestrosPage mostrarListadoMovimientos() {
		...
		if(apertura) {
			...
			System.out.println("KO : fallo en la apertura");
		}
		if(imas) {
			System.out.println("OK : carpeta IMAS generada");
		} else {
			System.out.println("!!! : no se ha creado carpeta IMAS, revisar si existe fallo. ");
		}
		System.out.println("=============================================================");
