...
public class DiarioSiniestrosPage extends PageObject {
	...
	public DiarioSiniestrosPage comprobarComunicacion() {
		...
		if(webDriver.getTextInFrame(filaListadoMovimientos, cuerpoFrame).contains(mensaje)) {
	...
	public DiarioSiniestrosPage mostrarListadoMovimientos() {
		...
		List<WebElement> listaMovimientos = webDriver.getElementsInFrame(listadoMovimientosSiniestro, cuerpoFrame);
