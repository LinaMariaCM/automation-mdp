...
public class GestionPagosPage extends PageObject {
	...
	private By mediosPagoBtn = By.cssSelector("#mediopago");
	private By nifPerceptorBtn = By.cssSelector("#perceptor");
	private By tramitadorBtn = By.cssSelector("#tramitador");
	private By nSiniestroInput = By.cssSelector("#numerosiniestro");
	private By productoBtn = By.cssSelector("#producto");
	...
	// Confirmación
	private By anyadirPagosConfirmarBtn = By.cssSelector("#listadoRecibos > div.menuNav.menuNavPosAbsolute > div > ul > li > a > span");
