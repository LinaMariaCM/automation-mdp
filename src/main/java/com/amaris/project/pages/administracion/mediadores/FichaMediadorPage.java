...
public class FichaMediadorPage extends PageObject {
	...
	private By visionGlobalBtn = By.cssSelector("[onclick*='subSecci=SEC_VISION_GLOBAL']");
	private By infoDescriptivaBtn = By.cssSelector("[onclick*='subSecci=SEC_INFO_DESCR']");
	private By infoContactoBtn = By.cssSelector("[onclick*='subSecci=SEC_INFO_CONTA']");
	private By infoRelacionalBtn = By.cssSelector("[onclick*='subSecci=SEC_INFO_RELAC']");
	private By infoTransaccionalBtn = By.cssSelector("subSecci=SEC_INFO_TRANS");
	private By condicionesNegocioBtn = By.cssSelector("[onclick*='subSecci=SEC_COND_NEG']");
	private By infoHistoricaBtn = By.cssSelector("[onclick*='subSecci=SEC_INFO_HIST']");
	private By infoCCMBtn = By.cssSelector("[onclick*='subSecci=SEC_INFO_CCM']");
	private By infoDGSBtn = By.cssSelector("[onclick*='subSecci=SEC_INFO_DGS']");
...
// alternativa private By fFormObligatoria = By.cssSelector("#formDatos > div.contentBox.anchuraCajas > div.marcofnd > table > tbody > tr:nth-child(2) > td > input"); o  name="feforobl"
	...
	private By actividadPrincipalDescr = By.cssSelector("#capaAjax > table > tbody > tr:nth-child(2) > td.tabla-izq > table > tbody > tr:nth-child(1) > td > table > tbody > tr:nth-child(5) > td:nth-child(2)");
	...
	private By contactoResponsableContacto = By.cssSelector("#capaAjax > table:nth-child(1) > tbody > tr:nth-child(2) > td > table > tbody > tr:nth-child(1) > td:nth-child(1) > table > tbody > tr:nth-child(2) > td:nth-child(1)");
	private By cargoResponsableContacto = By.cssSelector("#capaAjax > table:nth-child(1) > tbody > tr:nth-child(2) > td > table > tbody > tr:nth-child(1) > td:nth-child(1) > table > tbody > tr:nth-child(2) > td:nth-child(2)");
	private By telefonoPrincipal = By.cssSelector("#capaAjax > table:nth-child(1) > tbody > tr:nth-child(2) > td > table > tbody > tr:nth-child(1) > td:nth-child(1) > table > tbody > tr:nth-child(5) > td:nth-child(1)");
	private By emailPrincipal = By.cssSelector("#capaAjax > table:nth-child(1) > tbody > tr:nth-child(2) > td > table > tbody > tr:nth-child(1) > td:nth-child(1) > table > tbody > tr:nth-child(6) > td");
	...
	private By direccionComercialTxt = By.cssSelector("#capaAjax > table:nth-child(1) > tbody > tr:nth-child(2) > td > table > tbody > tr:nth-child(1) > td:nth-child(2) > table > tbody > tr > td > table > tbody > tr:nth-child(3) > td:nth-child(3)");
	...
	public FichaMediadorPage verificarDireccionComercial() {
		debugBegin();
		...
		boolean checkDireccionComercial = direccionComercial.equals("SAN GREGORIO 7 (02637) FUENSANTA - Albacete");
