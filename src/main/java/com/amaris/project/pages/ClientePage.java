...
public class ClientePage extends PageObject {
	...
	private By cmbtipoBlack = By.cssSelector("#motivo");// valida para marca
														// positiva(motivo)
	...
	private By btnOffBlack = By.cssSelector("body > div.pdata > div > ul > li:nth-child(2) > a");// se
																									// utiliza
																									// para
																									// marca
																									// posiviva
	...
	private By btnBorrar = By.cssSelector("body > div.pdata > div > ul > li:nth-child(3) > a");// valido
																								// para
																								// las
																								// dos
																								// marcas
	...
	public void datosTomador() {// aporte Jenney
		...
		// fecha de nacimiento
		this.webDriver.waitWithDriver(6000);
		this.webDriver.appendTextInFrame(this.txtFenac, this.menuFrameTomador, this.getTestVar("fecha_nacimiento"));// hasta
																													// aqui
																													// perfecto
	...
	public void anadirMarcaNegativa() {// Aporte jenney
		...
		// this.webDriver.clickElementFromDropDownByTextInFrame(this.cmbtipoBlack,this.capaIframe,
		// "CLIEXCLU");
