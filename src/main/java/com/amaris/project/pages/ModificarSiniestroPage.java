...
public class ModificarSiniestroPage extends PageObject {
...
public ModificarSiniestroPage(UserStory userS) {
    super(userS);
}


public ModificarSiniestroPage buscarPorNumeroPoliza(String numPoliza, String negocio) {
    debugBegin();
...
public ModificarSiniestroPage buscarPorNumeroSiniestro(String siniestro, int index, String anio, String negocio) {
    debugBegin();
...
public ModificarSiniestroPage buscarPorRecibo(String recibo1, String recibo2) {
    debugBegin();
...
public ModificarSiniestroPage buscarPorAsegurado(String asegurador, String opNombre, String nombre, String documento) {
    debugBegin();
...
public ModificarSiniestroPage buscarPorOcurrencia(String fDesde, String fHasta) {
    debugBegin();
...
public ModificarSiniestroPage buscarPorAlta(String fDesde, String fHasta) {
    debugBegin();
...
public ModificarSiniestroPage buscarPorCausa(String fDesde, String fHasta, String nombre) {
    debugBegin();
...
public ModificarSiniestroPage buscarPorOtros(String fDesde, String fHasta, String codMediador, String negocio) {
    debugBegin();
