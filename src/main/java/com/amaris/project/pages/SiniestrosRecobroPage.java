...
public class SiniestrosRecobroPage extends PageObject {

	// BLOQUE RECOBRO: RECOBRO es #bloque1tr2 porque es el segundo bloque, coger lo elaborado por Moha para ajustarlo aqui
	...
	public SiniestrosRecobroPage(UserStory userS) {
		super(userS);
	}
